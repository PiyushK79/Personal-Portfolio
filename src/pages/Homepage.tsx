...
import myresume from "../assets/Piyush_Kakde.pdf";
  ...
  return (
    <>
      <div className="grid lg:grid-rows-7 md:grid-rows-12 lg:grid-cols-8 md:grid-cols-4  sm:grid-rows-15 sm:grid-cols-4 justify-center lg:my-20 md:my-20 lg:px-40 md:px-20 sm:px-5 gap-4 select-none">
        ...
        >
          <div className="flex md:flex-row sm:flex-col justify-around items-center select-none">
            ...
            <div className="pl-1 leading-8 mt-10 max-w-sm">
              ...
              <h1 className="font-semibold text-5xl">Piyush Kakde.</h1>
        ...
        >
          <img
            className="invert w-40 sm:w-32 sm:m-2 place-self-center "
            src={signature}
            alt=""
          />
          <div className="px-6">
        ...
        >
          ...
          />
          <div className="px-6">
            <a id="arrowicon" href={myresume} target="_blank">
        ...
        >
          <div className="flex place-self-center gap-6 p-5 cursor-pointer">
            <a
              ...
              id="arrowicon" href="https://www.linkedin.com/in/piyush-kakde-6114ba214/"
              target="blank"
            >
            ...
            <a
              className="p-4 rounded-full border border-zinc-500 bg-zinc-900  hover:bg-white group"
              id="arrowicon" href="https://github.com/PiyushK79"
              target="blank"
            >
            ...
            <a
              className="p-4 rounded-full border border-zinc-500 bg-zinc-900 hover:bg-white group"
              id="arrowicon" href="https://twitter.com/Piyush_Kakde79"
              target="blank"
            >
        ...
        >
          <div className="flex gap-10 p-5 cursor-pointer place-self-center">
            <a
              className="p-4 rounded-full border border-zinc-500 bg-zinc-900 hover:bg-white group"
              id="arrowicon" href="https://www.behance.net/piyushkakde79"
              target="blank"
            >
            ...
            <a
              className="p-4 rounded-full border border-zinc-500 bg-zinc-900  hover:bg-white group"
              id="arrowicon" href="https://www.instagram.com/piyushkakde79/"
              target="blank"
            >
